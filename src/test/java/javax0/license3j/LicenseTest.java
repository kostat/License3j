...
class LicenseTest {
    ...
    private void addSampleFeatures(License sut,
                                   Date now) {
    ...
    void licenseSerializeAndDeserialize() {
        final License sut = new License();
        final Date now = new Date(1545051319295L);
        addSampleFeatures(sut, now);
    ...
    void testLicenseFingerprint() throws NoSuchAlgorithmException, IllegalBlockSizeException, InvalidKeyException,
