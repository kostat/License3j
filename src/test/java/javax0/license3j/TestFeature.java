...
public class FeatureTest {
    ...
    public void testWrongTypeDeserialization() {
        ...
        byte[] b = sut.serialized();
        b[3] = 0;
        Assertions.assertThrows(IllegalArgumentException.class, () -> Create.from(b));
    }
    ...
    public void testTruncatedDeserialization() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> Create.from(c));
    }
    ...
    public void testFactories() throws NoSuchFieldException, IllegalAccessException {
        ...
        for (final Object type : getTypeValues()) {
            ...
            Assertions.assertTrue(Modifier.isStatic(modifiers), "Method " + methodName + " is not static.");
            Assertions.assertTrue(Modifier.isPublic(modifiers), "Method " + methodName + " is not public.");
            Class<?>[] argtypes = method.getParameterTypes();
            Assertions.assertEquals(2, argtypes.length,
                    "Factory method " + methodName + " should have exactly two arguments.");
            Assertions.assertEquals(String.class, argtypes[0],
                    "Factory method " + methodName + " first argument has to be String.");
            if (argtypes[1].isArray()) {
                ...
                Assertions.assertEquals(VARIABLE_LENGTH, getFixedSize(type),
                        "array accepting factory " + methodName + " size has to be VARIABLE_LENGTH");
            }
        }
    }
    ...
    private Object createFeatureSut(Constructor<?> constructor,
                                    Object type)
    ...
    private Constructor<?> getFeatureConstructor() {
        ...
        final Constructor<?> constructor = Arrays.stream(constructors)
                ...
                .findAny()
                .orElseThrow(
                        () -> new AssertionFailedError("There is no appropriate constructor in the class Feature"));
        final int constructorModifiers = constructor.getModifiers();
        Assertions.assertTrue(Modifier.isPrivate(constructorModifiers),
                "The constructor of Feature has to be private.");
    ...
    public void testBinaryFromString() {
        ...
        Assertions.assertAll(() -> Assertions.assertEquals(b[0], (byte) 0xfe),
                () -> Assertions.assertEquals(b[1], (byte) 0x11), () -> Assertions.assertEquals(b[2], (byte) 0xaf));
    }
    ...
    public void testBigDecimalFromString() {
        final Feature sut = Feature.Create
                .from("name:BIGDECIMAL=123456789012345678901234567890.123456789012345678901234567890");
        Assertions.assertEquals("name", sut.name());
    ...
    public void testDateFromString() {
        ...
        Assertions.assertEquals(new Date(1545051319295L), sut1.getDate());
        ...
        Assertions.assertEquals(new Date(1545051319000L), sut2.getDate());
        ...
        Assertions.assertEquals(new Date(1545051300000L), sut3.getDate());
    }
    ...
    public void testBigintegerToString() {
        ...
        Assertions.assertEquals("name:BIGINTEGER=123456789012345678901234567890123456789012345678901234567890123456789",
                sut.toString());
    }
    ...
    public void testBigdecimalToString() {
        ...
        Assertions.assertEquals(
                "name:BIGDECIMAL=789012345678901234567890123456789.0123456789012345678901234567890123456789",
                sut.toString());
    }
    ...
    public void testDateToString() {
        final Feature sut = Feature.Create.dateFeature("now", new Date(1545051319295L));
