...
/**
 * Calculator to calculate a more or less unique code for the actual machine. The calculation uses the network cards,
 * host name and architecture of the machine.
 * <p>
 * This class is used by the {@link UUIDCalculator}. You, using License3j as a library, do not call methods in this
 * class directly.
 */
